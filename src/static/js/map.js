...
map.on("load", async () => {
  ...
  const popup = new mapboxgl.Popup({
      ...
      offset: popupOffsets
        ...
        map.on('click', 'unclustered-point', (e) => {
          //console.log('click: ' + e.features[0].properties.locationId)
        })
  ...
  // You can add custom images for markers if needed
  // map.loadImage('https://your-custom-marker.png', (error, image) => {
  ...
  data['FeatureCollection'].forEach((marker) => {
